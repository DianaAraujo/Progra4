<?php
  ...
  $preguntas = array("¿En que a&ntilde;o termino la segunda guerra mundial?","¿Como se llama el hombre más adinerado de Mexico?","¿Que día se celebra la independencia de El Salvador?");
  //Arreglos con respuestas
  $respuestas = array(array('En el a&ntilde;o 1945','En el a&ntilde;o 1995','En el año 2001','En el año 1981','correcta' => 0),array('Richard Branson','Carlos Slim','Amancio Ortega','Enrique Peña Nieto','correcta' => 1),array('El 12 de septiembre','El 15 de septiembre','El 24 de Diciembre','El 5 de septiembre','correcta' => 1));
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="respuestas">
          ...
          ?>
          <div class="col-md-6">
            <h4><a href="<?php echo "?id=".$link."&r=".$i;?>"><?php echo $respuestas[$id][$i]; ?></a></h4>
          </div>
          <?php
              }
            ?>
